...
class Server():
    ...
    def changeClientLimit(self, num):
        if (num >= 2 and num <= 10 and num > len(self.clientList)):
            ...
            print(
                "*** got to have at least 2 connections and less than 10. \n Also, must be more than current total of connected clients: ",
                str(len(self.clientList)))
    ...
    def lookUpClient(self, client):
        for c in self.clientList:
            try:
                ...
                print("Server doesn't have clients")
